...
@bot.command()
async def test(ctx):
    embed=discord.Embed(title="Details of the next pump", color=0xff8040)
    embed.add_field(name="GMT+9 (Seoul)", value="Thursday, April 22 2021 | 06:00:00", inline=False)
    embed.add_field(name="GMT (London)", value="Thursday, April 22 2021 | 06:00:00", inline=False)
    embed.add_field(name="EST (New York)", value="Thursday, April 22 2021 | 06:00:00", inline=False)
